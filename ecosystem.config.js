module.exports = {
  deploy: {
    production: {
      ...
      "post-deploy":
        "npm install --force; ng build --configuration production; cp -rf /root/projects/sources/1qma.admin/source/dist/coreui-free-angular-admin-template/browser /var/www/html/admin.1qma.games/;",
    },
